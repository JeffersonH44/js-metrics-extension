...
var VERSION_INFO = { version: "2.0.4", build: 1524202916283 };
...
var MountainChartComponent = Vizabi.Component.extend("mountainchart", {
  ...
  updateEntities: function updateEntities() {
    ...
    this.mountainPointers = this.model.marker.getKeys().filter(function (d) {
      return 1 && values.axis_x[utils.getKey(d, dataKeys.axis_x)] && values.axis_y[utils.getKey(d, dataKeys.axis_y)] && values.axis_s[utils.getKey(d, dataKeys.axis_s)];
    }).map(function (d) {
      var pointer = {};
      pointer._keys = d;
